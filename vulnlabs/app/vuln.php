...
<body>
  ...
  <ul class="dropdown-menu position-absolute w-100" aria-labelledby="dropdownMenuButton1">
    ...
    <li><a class="dropdown-item" href="#" onclick="setLanguage('es')"><img src="/public/assets/img/es.png" style="width: 26px; margin-right:5px;" />Castellano </a></li>
              ...
              <button class="accordion__btn">
                ...
                <span class="accordion__caption"><i class="far fa-lightbulb"></i><?php 
                    if ($lang == "tr"){
                      ...
                      echo 'Fuentes para el aprendizaje.';
                    }elseif ($lang =="fr"){
